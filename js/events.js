(function(global){
 ...
 const occursOn=(e,d)=>{const a=global.SK.dayStart(global.SK.parseDate(e.from)),b=global.SK.dayStart(global.SK.parseDate(e.to||e.from));return d>=a&&d<=b};
 global.SK=Object.assign(global.SK||{},{displayLocation,durationDays,isLongTerm,occursOn});
})(window);
